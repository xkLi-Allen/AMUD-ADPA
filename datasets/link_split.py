    ...
    try:
        ...
        for ind in range(splits):
            ...
            datasets[ind]['train']['label'] = torch.from_numpy(
                labels_train).long()
            #datasets[ind]['train']['weight'] = torch.from_numpy(label_train_w).float()
            ...
            datasets[ind]['val']['label'] = torch.from_numpy(
                labels_val).long()
            #datasets[ind]['val']['weight'] = torch.from_numpy(label_val_w).float()
            ...
            datasets[ind]['test']['label'] = torch.from_numpy(
                labels_test).long()
            #datasets[ind]['test']['weight'] = torch.from_numpy(label_test_w).float()
